...
import 'package:fyp_renterra_frontend/views/userView/dashboard/user_home_screen.dart';
...
class UserDashboardViewModel with ChangeNotifier {
  ...
  Widget getSelectedScreen(int index) {
    switch (index) {
      case 0:
        return const UserHomeScreen(); // Home tab content
      case 1:
      ...
      default:
        return UserHomeScreen(); // Default to Home tab
    }
  }
}
